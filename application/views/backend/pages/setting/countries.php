                ...
                <div class="card-body">
                    <div class="row">
                                <div class="col-md-12"> 
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#userModal" class="btn btn-outline-primary  btn-sm "><i class="fa fa-plus"></i> Add Country</button>
                                    </div>
                    ...
                    <table class="table table-striped table-bordered datatable" id="categoriestable">
                        <tbody>
                            ...
                            <?php
                            $baseurl = base_url();
                            foreach ($listsettingcountries as $country) {
                                $id = $country->id;
                                $url = "deletecountries/$id";
                                ?>
                                <li class="list-group-item list-group-item-light">
                                    <span class="text-success"><?php echo $country->name; ?></span>
                                    <div class="float-right">
                                         <span class="text-muted"><?php echo $country->orderby; ?></span> | 
        ...
        <form method="post" id="user_form">
            <div class="modal-content">
               <div class="modal-header">
                    <h4 class="modal-title float-left"><i class="fa fa-folder-open"></i> Add Country</h4>
                </div>
...
$(document).ready(function(){
 ...
 $(document).on('submit','#user_form' , function(event){
   ...
   {
      $.ajax({
         url:"<?php echo base_url() . 'setting/countries'?>",
         method: 'POST',
