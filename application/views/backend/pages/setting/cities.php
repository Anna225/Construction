                ...
                <div class="card-body">
                    <div class="row">
                                <div class="col-md-12"> 
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#userModal" class="btn btn-outline-primary  btn-sm "><i class="fa fa-plus"></i> Add City</button>
                                    </div>
                    ...
                    <table class="table table-striped table-bordered datatable" id="categoriestable">
                        <tbody>
                            ...
                            <?php
                            $baseurl = base_url();
                            foreach ($listsettingcities as $city) {
                                $id = $city->id;
                                $url = "deletecity/$id";
                                ?>
                                <li class="list-group-item list-group-item-light">
                                    <span class="text-success"><?php echo $city->name; ?></span>
                                    <div class="float-right">
                                         <span class="text-muted"><?php echo $city->orderby; ?></span> | 
        ...
        <form method="post" id="user_form">
            <div class="modal-content">
               <div class="modal-header">
                    <h4 class="modal-title float-left"><i class="fa fa-folder-open"></i> Add City</h4>
                </div>
                <div class="modal-body">
                    ...
                    <label class="col-md-8 col-form-label">City Name</label>
                    <div class="col-md-8">
...
$(document).ready(function(){
 ...
 $(document).on('submit','#user_form' , function(event){
   ...
   {
      $.ajax({
         url:"<?php echo base_url() . 'setting/cities'?>",
         method: 'POST',
