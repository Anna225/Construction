                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12"> 
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#userModal" class="btn btn-outline-primary  btn-sm "><i class="fa fa-plus"></i> Add Types</button>
                                    </div>
...
<script type="text/javascript" language="javascript">
    ...
    {
    $.ajax({
    url:"<?php echo base_url() . 'setting/types' ?>",
            method: 'POST',
