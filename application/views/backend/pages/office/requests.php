    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-10">
                                <?php
                                    $this->load->view('backend/pages/office/common/allreqcategories');
                                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions ">
                                <button type="button" data-toggle="modal" data-target="#userModal"  class="btn btn-outline-primary btn-sm"><i class="fa fa-plus fa-lg"></i>&nbsp; Add</button>
                            </div>
                        </div>
