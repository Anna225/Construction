                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 text-center bg-danger text-white font-weight-bold">10 Marla A+</div>
                                    <div class="col-lg-3 text-center bg-success text-white font-weight-bold">10 Marla A</div>
                                    <div class="col-lg-3 text-center bg-primary text-white font-weight-bold">10 Marla B</div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3"></div>
                                    <div class="col-lg-3">
                                        <div class="row package1">
                                            <div class="col-lg-3  text-muted font-weight-bold">Qty</div>
                                            <div class="col-lg-3  text-muted font-weight-bold">Rate</div>
                                            <div class="col-lg-6  text-muted font-weight-bold">Amount</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <div class="row subcategory">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                foreach ($listpackages as $package) {
                                                    ...
                                                    $packagesdata = $this->mpackages->getListPackageCosts($package->id,$subcate->id);  
                                                    $qtyoftenmarla = $this->mpackages->getListQtyOfTenMarla($subcate->id,5);
                                                ...
                                                <?php 
                                                    foreach ($packagesdata as $pkdata) 
                                                        {
                                                        $itemprice = $packagesdata[0]->rate;
                                                        $itemrate = $qtyoftenmarla[0]->qty;
                                                        $finalamount = ($itemrate * $itemprice);
                                                      
                                                        echo '<div class="col-lg-4  '.$package->text_class.' ">'.$itemrate.'</div>
                                                              <div class="col-lg-4  '.$package->text_class.' ">'.$itemprice.'</div>
                                                              <div class="col-lg-4  font-weight-bold '.$package->text_class.' ">'.$finalamount.'</div>';
