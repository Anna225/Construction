                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="float-right">
                                        ...
                                        <a href="productslist" target="_self" class="btn btn-outline-success  btn-sm"><i class="fa fa-reorder"></i> Join List</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($listpackagesproducts['records'] as $rows) {
                                        echo "<tr>
                                            ...
                                            <td>" . ucwords($rows['companytitle']) . " - " . $rows['countrytitle'] . "</td>
                                            <td>" . $rows['action'] . "</td>
                                            </tr>";
                                    }
                                    ?>
                            ...
                            <div>
                                ...
                                <div class="col-md-8">
                                    <label class="radio-inline" for="inline-radio0">
                                        <input type="radio" id="inline-radio0" name="type" value="0"> Na
                                    </label>
                                    ...
                                    <label class="radio-inline" for="inline-radio4">
                                        <input type="radio" id="inline-radio4" name="type" value="4"> Ft
                                    </label>
                                    <label class="radio-inline" for="inline-radio5">
                                        <input type="radio" id="inline-radio5" name="type" value="5"> Qty
                                    </label>
