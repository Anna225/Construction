          ...
          <div class="col-md-10">
            <div class="card">
                <div class="card-header ">
                  <i class="fa fa-edit"></i> Created Invoices
        ...
        <div class="col-sm-8 col-lg-12" style="margin-top: 20px;">
            <div class="row">
                <div class="col-sm-2">
                    ...
                    echo form_dropdown('fk_company', $companyDrpdwnList, $selected_companyid, 'data-rel="chosen" id="fk_company" class="form-control" style="text-transform: capitalize;" onchange="invoicesFilter()"'); ?>
                </div>
                <div class="col-sm-2">
                    <?php 
                    ...
                    echo form_dropdown('fk_project', $projectDrpdwnList, $selected_projectid, 'data-rel="chosen" id="fk_project" class="form-control" style="text-transform: capitalize;" onchange="invoicesFilter()"'); ?>
                </div>
