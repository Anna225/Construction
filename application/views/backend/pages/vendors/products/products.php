    ...
    <div class="card">
            <div class="card-header ">
              ...
              <button type="button" class="btn btn-outline-secondary btn-sm float-right font-sm">
               <a href="<?php echo base_url() ;?>vendor/addproducts/<?php echo $this->uri->segment(3); ?>"><i class="fa fa-plus-circle"></i> Add Products</a>
              </button> 
              ...
              <table class="table table-striped table-bordered datatable">
                ...
                <tbody>
                  ...
                  <?php
                            ...
                            foreach ($vendorproductslist['records'] as $rows )
				{
